...
// awk '/{.*TOKEN_/ { gsub(/[{",]/, ""); if (prev > $1) print "OUT OF ORDER: " prev " > " $1 " (line " NR ")"; prev = $1 }' src/parser/lexer.c
static const KeywordMap keywords[] = {
    ...
    {"by", TOKEN_BY},
    {"cache", TOKEN_CACHE},
    {"canonical", TOKEN_CANONICAL},
    {"cascade", TOKEN_CASCADE},
    {"check", TOKEN_CHECK},
    {"collatable", TOKEN_COLLATABLE},
    ...
    {"input", TOKEN_INPUT},
    {"internallength", TOKEN_INTERNALLENGTH},
    {"key", TOKEN_KEY},
    {"last", TOKEN_LAST},
    {"like", TOKEN_LIKE},
    {"list", TOKEN_LIST},
    ...
    {"passedbyvalue", TOKEN_PASSEDBYVALUE},
    {"period", TOKEN_PERIOD},
    {"plain", TOKEN_PLAIN},
    {"precision", TOKEN_PRECISION},
    {"preferred", TOKEN_PREFERRED},
    ...
    {"to", TOKEN_TO},
    {"type", TOKEN_TYPE},
    {"typmod_in", TOKEN_TYPMOD_IN},
    {"typmod_out", TOKEN_TYPMOD_OUT},
    {"unique", TOKEN_UNIQUE},
